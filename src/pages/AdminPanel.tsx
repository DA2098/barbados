                    ...
                    <td className="p-3">
                      <div className="flex items-center gap-3">
                        <a href={p.image_url || 'https://via.placeholder.com/80?text=Item'} target="_blank" rel="noreferrer">
                          <img src={p.image_url || 'https://via.placeholder.com/80?text=Item'} alt={p.name} className="w-20 h-20 rounded object-contain bg-white/5 p-1" />
                        </a>
                        <div>
                    ...
                    <td className="p-3">
                      <div className="flex items-center gap-3">
                        <a href={cut.image_url || 'https://via.placeholder.com/80?text=Corte'} target="_blank" rel="noreferrer">
                          <img src={cut.image_url || 'https://via.placeholder.com/80?text=Corte'} alt={cut.name} className="w-20 h-20 rounded object-contain bg-white/5 p-1" />
                        </a>
                        <div>
