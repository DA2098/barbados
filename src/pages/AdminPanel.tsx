                  ...
                  <tr key={p.id} className="hover:bg-white/5 transition-colors">
                    <td className="pt-0 pb-6 align-top">
                      <div className="flex items-start gap-3">
                        <a href={p.image_url || 'https://via.placeholder.com/480?text=Item'} target="_blank" rel="noreferrer" className="shrink-0 mr-3">
                          <img src={p.image_url || 'https://via.placeholder.com/480?text=Item'} alt={p.name} className="w-44 h-44 object-contain object-center rounded bg-white/5 p-1 -mt-2 shrink-0" />
                        </a>
                        <div>
              ...
              <tbody className="divide-y divide-white/10">
                {cuts.map((cut) => (
                  <tr key={cut.id} className="hover:bg-white/5 transition-colors">
                    <td className="pt-0 pb-6 align-top">
                      <div className="flex items-start gap-3">
                        <a href={cut.image_url || 'https://via.placeholder.com/480?text=Corte'} target="_blank" rel="noreferrer" className="shrink-0 mr-3">
                          <img src={cut.image_url || 'https://via.placeholder.com/480?text=Corte'} alt={cut.name} className="w-44 h-44 object-contain object-center rounded bg-white/5 p-1 -mt-2 shrink-0" />
                        </a>
                        <div>
